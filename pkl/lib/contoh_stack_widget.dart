...
class ContohStackWidget extends StatefulWidget {
  @override
  _ContohStackWidgetState createState() => _ContohStackWidgetState();
}

class _ContohStackWidgetState extends State<ContohStackWidget> {
