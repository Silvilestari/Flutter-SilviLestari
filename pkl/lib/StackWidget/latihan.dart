...
class LatihanStackWidget extends StatefulWidget {
  @override
  _LatihanStackWidgetState createState() => _LatihanStackWidgetState();
}

class _LatihanStackWidgetState extends State<LatihanStackWidget> {
